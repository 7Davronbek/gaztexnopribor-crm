...
const AccountantClientListPage = () => {
    ...
    return (
        <>
            ...
            <div
                className={`myModal middleModal accountantModal ${isOpen && " active "} ${layoutSelection.value}`}
            >
                <div className="cards">
                    <PDFExport ref={pdfExportComponent} className={`${layoutSelection.value} `}>
                    ...
                    <div className="btnWrap">
                        <button onClick={handleExportWithComponent} className="btn cardsBtn silver">Скачать PDF
                        </button>
                        <button
