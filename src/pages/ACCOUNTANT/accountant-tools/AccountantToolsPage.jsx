...
const AccountantToolsPage = () => {
    ...
    const deleteProduct = async (id) => {
        setIsTool(true)
        await axios.delete(API_PATH + `/main/product-rud/${id}/`, CONFIG)
            .then(() => {
        ...
        <>
            ...
            >
                <form onSubmit={productPatch} className="cards">
                    ...
                    <div className="btnWrap">
                        <button disabled={isTool} type="submit" className="btn cardsBtn me-2">
                            {isTool && (
                                <i className="spinner-border spinner-border-sm text-white text-dark me-2"></i>
                            )}
                            Сохранить
                        </button>
                        <button disabled={isTool} onClick={() => deleteProduct(product.id)} className="btn cardsBtn silver">
                            {isTool && (
                                <i className="spinner-border spinner-border-sm text-white text-dark me-2"></i>
                            )}
                            Удалить
